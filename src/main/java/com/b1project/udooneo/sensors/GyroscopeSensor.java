...
public class GyroscopeSensor extends Sensor {
    ...
    public static void enableSensor(boolean enable) throws Exception{
        File file = new File(FileUtils.GYROSCOPE_ACTIVATION_URI);
    ...
    public static boolean isEnabled(){
        try {
            return Integer.parseInt(read(FileUtils.GYROSCOPE_ACTIVATION_URI)) == 1;
        } catch (Exception e) {
    ...
    public static String getData(){
        try {
            return read(FileUtils.GYROSCOPE_DATA_URI);
        } catch (Exception e) {
            System.err.println("\rError: " + e.getMessage());
            System.out.print("#:");
        }
